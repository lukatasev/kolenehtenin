...
<main class="w-full flex-grow">
    ...
    <section class="border-b border-surfaceContainer bg-surfaceContainer/30">
        <div class="max-w-5xl mx-auto px-6 py-14">
            <h1 class="text-3xl font-semibold text-onSurface">Стручни Насоки</h1>
            <p class="text-base text-onSurface/60 mt-2">Образовни профили за директно вклучување на пазарот на трудот.</p>
        </div>
    </section>
    ...
    <section class="py-16 px-6 max-w-5xl mx-auto space-y-14">
        ...
        <!-- Електротехничка -->
        <div class="space-y-4">
            <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3">Електротехничка струка</h2>
            ...
            <details class="border border-surfaceContainer group">
                <summary class="p-5 cursor-pointer flex items-center justify-between text-onSurface hover:bg-surfaceContainer/30 transition-colors">
                    <div class="flex flex-col gap-1 flex-grow">
                        <span class="text-base font-medium">Електротехничар – енергетичар</span>
                        <div class="flex flex-wrap gap-2 text-xs text-onSurface/50">
                            <span>4 години</span>
                        </div>
                    </div>
        ...
        <!-- Машинска -->
        <div class="space-y-4">
            <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3">Машинска струка</h2>
            
            <details class="border border-surfaceContainer group">
                <summary class="p-5 cursor-pointer flex items-center justify-between text-onSurface hover:bg-surfaceContainer/30 transition-colors">
                    <div class="flex flex-col gap-1 flex-grow">
                        <span class="text-base font-medium">Техничар за компјутерско управување</span>
                        <div class="flex flex-wrap gap-2 text-xs text-onSurface/50">
                            <span>4 години</span>
                        </div>
                    </div>
            ...
            <details class="border border-surfaceContainer group">
                <summary class="p-5 cursor-pointer flex items-center justify-between text-onSurface hover:bg-surfaceContainer/30 transition-colors">
                    <div class="flex flex-col gap-1 flex-grow">
                        <span class="text-base font-medium">Машински техничар</span>
                        <div class="flex flex-wrap gap-2 text-xs text-onSurface/50">
                            <span>4 години</span>
            ...
            <details class="border border-surfaceContainer group">
                <summary class="p-5 cursor-pointer flex items-center justify-between text-onSurface hover:bg-surfaceContainer/30 transition-colors">
                    <div class="flex flex-col gap-1 flex-grow">
                        <span class="text-base font-medium">Машински енергетски техничар</span>
                        <div class="flex flex-wrap gap-2 text-xs text-onSurface/50">
                            <span>4 години (III ниво)</span>
                            <span>Мин. 45 поени</span>
                        </div>
                    </div>
                    <span class="text-onSurface/40 group-open:rotate-180 transition-transform text-sm">&darr;</span>
            ...
            <details class="border border-surfaceContainer group">
                <summary class="p-5 cursor-pointer flex items-center justify-between text-onSurface hover:bg-surfaceContainer/30 transition-colors">
                    <div class="flex flex-col gap-1 flex-grow">
                        <span class="text-base font-medium">Автотехничар - мехатроничар</span>
                        <div class="flex flex-wrap gap-2 text-xs text-onSurface/50">
                            <span>4 години</span>
                        </div>
                    </div>
                ...
                <div class="px-5 pb-5 pt-2 border-t border-surfaceContainer text-sm text-onSurface/70">
                    <p class="leading-relaxed">
                        Со изучување на образовниот профил автотехничар – мехатроничар, ученикот се здобива со знаења од областа на математиката, физиката, техничкото цртање, машинските елементи, технологијата на моторните возила, контролната технологија, како и електротехниката и електрониката.
                    </p>
                </div>
            </details>
            ...
            <details class="border border-surfaceContainer group">
                <summary class="p-5 cursor-pointer flex items-center justify-between text-onSurface hover:bg-surfaceContainer/30 transition-colors">
                    <div class="flex flex-col gap-1 flex-grow">
                        <span class="text-base font-medium">Машински механичар</span>
                        <div class="flex flex-wrap gap-2 text-xs text-onSurface/50">
                            <span>3 години</span>
                        </div>
                    </div>
            ...
            <details class="border border-surfaceContainer group">
                <summary class="p-5 cursor-pointer flex items-center justify-between text-onSurface hover:bg-surfaceContainer/30 transition-colors">
                    <div class="flex flex-col gap-1 flex-grow">
                        <span class="text-base font-medium">Конструкциски механичар</span>
                        <div class="flex flex-wrap gap-2 text-xs text-onSurface/50">
                            <span>3 години</span>
                ...
                <div class="px-5 pb-5 pt-2 border-t border-surfaceContainer text-sm text-onSurface/70">
                    <p class="mb-2 font-medium text-onSurface">Оспособен:</p>
                    <ul class="list-disc pl-5 space-y-1 leading-relaxed">
                        <li>подготвува елементи: лимови, профили и цевки за спојување на конструкции и цевководи;</li>
                        ...
                        <li>применува хигиенско – техничка заштита;</li>
                        <li>се грижи за заштитата на работната и животната средина;</li>
                    </ul>
                    <div class="mt-4 flex flex-wrap gap-4 text-xs text-onSurface/40 bg-surfaceContainer/30 p-3">
                        <span>Број на ученици: 24</span>
                        <span>Број на паралелки: 1</span>
                    </div>
                </div>
            </details>
        ...
        <!-- Угостителска -->
        <div class="space-y-4">
            <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3">Угостителска струка</h2>
