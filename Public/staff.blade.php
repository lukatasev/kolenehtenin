            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
                    ...
                    <div class="flex flex-col gap-0.5">
                        <span class="text-sm font-medium">{{ tr('staff.titles.defectologist') }} Весна Ивкова</span>
                        <span class="text-xs text-onSurface/50">{{ tr('staff.titles.special_educator') }}</span>
                ...
                <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
                    ...
                    <div class="flex flex-col gap-0.5">
                        <span class="text-sm font-medium">{{ tr('staff.titles.pedagogue') }} Славица Глигоров</span>
                        <span class="text-xs text-onSurface/50">{{ tr('staff.titles.electrical') }}</span>
                ...
                <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
                    ...
                    <div class="flex flex-col gap-0.5">
                        <span class="text-sm font-medium">{{ tr('staff.titles.pedagogue') }} Сузана Л. Ефтимова</span>
                        <span class="text-xs text-onSurface/50">{{ tr('staff.titles.machine_hospitality') }}</span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
                    ...
                    <div class="flex flex-col gap-0.5">
                        ...
                        <span class="text-xs text-onSurface/50">{{ tr('staff.titles.electro_engineer') }}</span>
                ...
                <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
                    ...
                    <div class="flex flex-col gap-0.5">
                        ...
                        <span class="text-xs text-onSurface/50">{{ tr('staff.titles.it_engineer') }}</span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
                    ...
                    <div class="flex flex-col gap-0.5">
                        ...
                        <span class="text-xs text-onSurface/50">{{ tr('staff.titles.mechanical_engineer') }}</span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
                    ...
                    <div class="flex flex-col gap-0.5">
                        ...
                        <span class="text-xs text-onSurface/50">{{ tr('staff.titles.mathematician') }}</span>
