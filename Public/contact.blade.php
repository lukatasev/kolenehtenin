...
<main class="w-full flex-grow">
    ...
    <section class="border-b border-surfaceContainer bg-surfaceContainer/30">
        <div class="max-w-5xl mx-auto px-6 py-14">
            <h1 class="text-3xl font-semibold text-onSurface">{{ tr('contact.title') }}</h1>
        </div>
    </section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div class="space-y-8">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-sm font-semibold text-onSurface uppercase tracking-wider mb-1">{{ tr('contact.address') }}</h3>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-sm font-semibold text-onSurface uppercase tracking-wider mb-1">{{ tr('contact.phone') }}</h3>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-sm font-semibold text-onSurface uppercase tracking-wider mb-1">{{ tr('contact.email') }}</h3>
                        <p class="text-onSurface/70">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-sm font-semibold text-onSurface uppercase tracking-wider mb-1">{{ tr('contact.social') }}</h3>
