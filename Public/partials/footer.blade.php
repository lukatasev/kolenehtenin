<footer class="bg-surface border-t border-surfaceContainer pt-12 pb-6 px-6 mt-auto">
    <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm text-onSurface/60">
                ...
                <li><a href="/gallery" class="hover:text-onSurface transition-colors">{{ tr('nav.gallery') }}</a></li>
                <li><a href="/news" class="hover:text-onSurface transition-colors">{{ tr('nav.news') }}</a></li>
                <li><a href="/contact" class="hover:text-onSurface transition-colors">{{ tr('nav.contact') }}</a></li>
            </ul>
        </div>
        
        <div>
            <h4 class="text-xs font-semibold mb-3 text-onSurface uppercase tracking-wider">{{ tr('contact.title') }}</h4>
            <ul class="space-y-2 text-sm text-onSurface/60">
                <li>Бул. Гоце Делчев бр. 101, {{ tr('school.city') }}</li>
