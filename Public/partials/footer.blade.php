    ...
    <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        <div class="space-y-3">
            <div class="flex items-center gap-2 mb-2">
                ...
                <h3 class="text-base font-semibold text-onSurface">ДСУ РЦСОО „Коле Нехтенин"</h3>
            </div>
        ...
        <div>
            <h4 class="text-xs font-semibold mb-3 text-onSurface uppercase tracking-wider">Контакт</h4>
            <ul class="space-y-2 text-sm text-onSurface/60">
                <li>Бул. Гоце Делчев бр. 101, Штип</li>
