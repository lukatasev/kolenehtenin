...
<main class="w-full flex-grow">
 ...
 <h1 class="text-3xl font-semibold text-onSurface"><?php echo \htmlentities(tr('staff.title'), ENT_QUOTES, 'UTF-8', false); ?></h1>
 <p class="text-base text-onSurface/60 mt-2"><?php echo \htmlentities(tr('staff.subtitle'), ENT_QUOTES, 'UTF-8', false); ?></p>
 </div>
 </section>
 ...
 <!-- Director -->
 <div class="space-y-4">
 <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3"><?php echo \htmlentities(tr('staff.director'), ENT_QUOTES, 'UTF-8', false); ?></h2>
 ...
 <p class="text-sm text-onSurface/60 leading-relaxed"><?php echo \htmlentities(tr('staff.director_bio'), ENT_QUOTES, 'UTF-8', false); ?></p>
 </div>
 </div>
 </div>
 ...
 <!-- Pedagogues -->
 <div class="space-y-4">
 <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3"><?php echo \htmlentities(tr('staff.pedagogues'), ENT_QUOTES, 'UTF-8', false); ?></h2>
 ...
 <span class="text-sm font-medium"><?php echo \htmlentities(tr('staff.titles.defectologist'), ENT_QUOTES, 'UTF-8', false); ?> Весна Ивкова</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.special_educator'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium"><?php echo \htmlentities(tr('staff.titles.pedagogue'), ENT_QUOTES, 'UTF-8', false); ?> Славица Глигоров</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electrical'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium"><?php echo \htmlentities(tr('staff.titles.pedagogue'), ENT_QUOTES, 'UTF-8', false); ?> Сузана Л. Ефтимова</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.machine_hospitality'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <!-- Electro -->
 <div class="space-y-4">
 <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3"><?php echo \htmlentities(tr('staff.electro_active'), ENT_QUOTES, 'UTF-8', false); ?></h2>
 <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
 <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Љупче Јаневски</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Сашко Јордев</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Владо Арсов</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Александар Иванов</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Виолета Максимовска</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Тони Максимовски</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Стефан Михајлов</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Мартина Пешевска</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Зоран Поп Томов</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Деспина Ристова Делипетрева</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Александра Романова Тасевски</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Дејан Рунчев</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Душко Стефанов</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Ивана Стојанова</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.it_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Јулијана Ташкова</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 <a href="mailto:jule_taskova@yahoo.com" class="text-xs text-primary hover:underline">jule_taskova@yahoo.com</a>
 </div>
 </div>
 <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
 <img src="/assets/images/vraboteni/stojan_hadzi_nikolov.jpg" alt="Хаци-Николов Стојан" class="w-20 h-20 object-cover object-top rounded-sm cursor-pointer" data-lightbox>
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Стојан Хаци-Николов</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.electro_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <!-- Machine -->
 <div class="space-y-4">
 <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3"><?php echo \htmlentities(tr('staff.machine_active'), ENT_QUOTES, 'UTF-8', false); ?></h2>
 <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
 <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Даниел Ѓорѓиевски</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Марјанчо Јованов</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Тамара Димова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Томе Коловски</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mechanical_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Борис Крлански</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mechanical_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Атанас Крстовски</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Игор Милев</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mechanical_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Александар Наумов</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mechanical_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Венцислав Панев</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mechanical_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Тоне Петров</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mechanical_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Далибор Саздов</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Драган Станков</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mechanical_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Жарко Христовски</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mechanical_engineer'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <!-- Hospitality -->
 <div class="space-y-4">
 <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3"><?php echo \htmlentities(tr('staff.hospitality_active'), ENT_QUOTES, 'UTF-8', false); ?></h2>
 <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
 <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Горан Антониевски</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Митко Коцев</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Јулијана Саздова</span>
 ...
 <!-- Math/Science -->
 <div class="space-y-4">
 <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3"><?php echo \htmlentities(tr('staff.math_science_active'), ENT_QUOTES, 'UTF-8', false); ?></h2>
 <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
 <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Зоран Ѓоргиев</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mathematician'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Жаклина Атова</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mathematician'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Јорданка Ивановска</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Вилма Илиевска</span>
 <span class="text-xs text-onSurface/50"><?php echo \htmlentities(tr('staff.titles.mathematician'), ENT_QUOTES, 'UTF-8', false); ?></span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Радмила Кашикова Филипова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Лидија Кишишева</span>
 ...
 <!-- General -->
 <div class="space-y-4">
 <h2 class="text-xl font-semibold text-onSurface border-b border-surfaceContainer pb-3"><?php echo \htmlentities(tr('staff.general_active'), ENT_QUOTES, 'UTF-8', false); ?></h2>
 <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
 <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Ана Јовева</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Драгана Љуботенска</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Силвана Андонова Иванова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Зоран Арсов</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Сузана Арсова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Катерина Донева</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Виолета Заринска</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Антонио Киров</span>
 <a href="mailto:vzorinska@yahoo.com" class="text-xs text-primary hover:underline">vzorinska@yahoo.com</a>
 </div>
 </div>
 <div class="border border-surfaceContainer p-5 flex flex-col items-center text-center gap-2">
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Лилјана Манова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Наташа Митев</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Елизабета Протогерова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Методи Самарджиски</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Александра Срцева Лазова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Катерина Маролова Стефанова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Сара Стоилова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Данче Тошева</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Лидија Трендафилова</span>
 ...
 <div class="flex flex-col gap-0.5">
 <span class="text-sm font-medium">Мирјана Фичорска</span>
 </div>
 </div>
 </div>
 </div>
