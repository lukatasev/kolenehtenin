<?php defined("INDLUCE_CHECK") || die("404"); ?><header class="w-full bg-surface border-b border-surfaceContainer">
 ...
 <img src="/assets/images/logo.jpg" alt="<?php echo \htmlentities(tr('school.name'), ENT_QUOTES, 'UTF-8', false); ?> Лого" class="h-9 w-auto rounded-sm object-contain">
 <div class="hidden sm:flex flex-col">
 <span class="text-base font-semibold text-onSurface leading-tight"><?php echo \htmlentities(tr('school.name'), ENT_QUOTES, 'UTF-8', false); ?></span>
 <span class="text-[11px] text-onSurface/50 tracking-wide"><?php echo \htmlentities(tr('school.city'), ENT_QUOTES, 'UTF-8', false); ?></span>
 </div>
 </a>
 
 <nav class="hidden lg:flex items-center gap-5 text-sm">
 <a href="/about" class="text-onSurface/70 hover:text-onSurface transition-colors whitespace-nowrap"><?php echo \htmlentities(tr('nav.about'), ENT_QUOTES, 'UTF-8', false); ?></a>
 <a href="/programs" class="text-onSurface/70 hover:text-onSurface transition-colors whitespace-nowrap"><?php echo \htmlentities(tr('nav.programs'), ENT_QUOTES, 'UTF-8', false); ?></a>
 ...
 <a href="/about" class="text-onSurface/70 hover:text-onSurface transition-colors py-2"><?php echo \htmlentities(tr('nav.about'), ENT_QUOTES, 'UTF-8', false); ?></a>
 <a href="/programs" class="text-onSurface/70 hover:text-onSurface transition-colors py-2"><?php echo \htmlentities(tr('nav.programs'), ENT_QUOTES, 'UTF-8', false); ?></a>
