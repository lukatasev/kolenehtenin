...
<main class="w-full flex-grow">
 ...
 <h1 class="text-3xl font-semibold text-onSurface"><?php echo \htmlentities(tr('news.title'), ENT_QUOTES, 'UTF-8', false); ?></h1>
 <p class="text-base text-onSurface/60 mt-2"><?php echo \htmlentities(tr('news.subtitle'), ENT_QUOTES, 'UTF-8', false); ?></p>
 ...
 <?php if (empty($news)): ?>
 <p class="text-onSurface/50 text-center py-12"><?php echo \htmlentities(tr('news.no_news'), ENT_QUOTES, 'UTF-8', false); ?></p>
 <?php else: ?>
 ...
 &larr; <?php echo \htmlentities(tr('news.previous'), ENT_QUOTES, 'UTF-8', false); ?>
 ...
 <a href="/news?page=<?php echo $current_page + 1; ?>" class="px-4 py-2 text-sm border border-surfaceContainer rounded-sm hover:bg-surfaceContainer transition-colors text-onSurface/70 hover:text-onSurface">
 <?php echo \htmlentities(tr('news.next'), ENT_QUOTES, 'UTF-8', false); ?> &rarr;
 </a>
 <?php endif; ?>
 </div>
 <?php endif; ?>
